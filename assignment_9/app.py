...
def ask_llm(context, user_input):
    system_prompt = """You are a helpful laptop recommendation assistant. Use the provided context to recommend 
    the best laptop(s) for the user's needs. Include specific features and explain why they match the user's requirements. 
    Also mention the price if available. Reply in a friendly, conversational style but be concise."""
    
    user_prompt = (
        f"User requirements: {user_input}\n\n"
        f"Context (relevant laptops):\n{context}\n\n"
...
sample_queries = [
    ...
    "Need a powerful laptop for video editing and 3D rendering.",
    "Recommend a laptop for programming and software development."
]
